...
▶ Создание нового тега (существует 1.1 -> создаем 1.2)
```bash
    git tag v1.2
```
...
Если был создан MINOR-тег (v1.1, v1.5, v2.6 или другой), необходимо обновить основной MAJOR-тег:
```bash
    git tag -f v1
```
